...
/******************************************************************************
       ...
       Entry data: x1, y1 top coordinates
                   x2, y2 left bottom coordinates
                   x3, y4 right bottom coordinates
       Return value: None
******************************************************************************/
void LCD_DrawTriangle(u16 x1, u16 y1, u16 x2, u16 y2, u16 x3, u16 y3, u16 color) {
