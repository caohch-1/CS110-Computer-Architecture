...
```
git clone https://autolab.sist.shanghaitech.edu.cn/gitlab/cs110_21s/p2.1_framework.git
git remote set-url origin https://autolab.sist.shanghaitech.edu.cn/gitlab/cs110_21s_projects/p2.1_xxx_xxx.git
```

Check if you already have the following files after cloning.
