...
(file_locations,'reference_output/alu-add-ref.out'), "")),
  ...
  ('ALU bitpal test', "student_output/alu-bitpal-student.out", TestCase(os.path.join(file_locations,'alu_tests/alu-bitpal.circ'), os.path.join(file_locations,'reference_output/alu-bitpal-ref.out'), "")),
